...
```scala
// JPL integration
libraryDependencies += "dev.zio" %% "zio-logging-jpl" % "0.5.16"

// SLF4j v1 integration
libraryDependencies += "dev.zio" %% "zio-logging-slf4j" % "0.5.16"

// SLF4j v2 integration
libraryDependencies += "dev.zio" %% "zio-logging-slf4j2" % "0.5.16"

// Using ZIO Logging for SLF4j v1 loggers, usually third-party non-ZIO libraries
libraryDependencies += "dev.zio" %% "zio-logging-slf4j-bridge" % "0.5.16"

// Using ZIO Logging for SLF4j v2 loggers, usually third-party non-ZIO libraries
libraryDependencies += "dev.zio" %% "zio-logging-slf4j2-bridge" % "0.5.16"
```
