...
```scala
// JPL integration
libraryDependencies += "dev.zio" %% "zio-logging-jpl" % "2.1.7"

// SLF4j integration
libraryDependencies += "dev.zio" %% "zio-logging-slf4j" % "2.1.7"

// Using ZIO Logging for SLF4j loggers, usually third-party non-ZIO libraries
libraryDependencies += "dev.zio" %% "zio-logging-slf4j-bridge" % "2.1.7"
```
